...
```json
{
    ...
    "name":"test de création avec validation validate authorize test e pmodel_namescsefdfbdfzfvffbfvqfdsdfd",
    "pmodel_name": "I get it.",
    "unit_price": 666.01,
    "description":"test de création validate authorize test tables relations test epmodel_nsvvfvascsmeddfvsgsgvsdvsfefgdffd",
    "status": 1,
    "color":"red",
    "customizable": null,
    "is_active":true,
